...
import "../../govern-token/contracts/GovernTokenFactory.sol";
import "../../govern-token/contracts/interfaces/IERC20.sol";
import "../../govern-token/contracts/GovernMinter.sol";
import "../../govern-token/contracts/libraries/TokenLib.sol";
...
contract GovernBaseFactory {
    ...
    string private constant ERROR_SCHEDULE_LIST_EXCEEDED =
        "basefactory: schedule list exceeded";
    ...
    function newGovern(
        ...
        require(
            _scheduleAccessList.length <= MAX_SCHEDULE_ACCESS_LIST_ALLOWED,
            ERROR_SCHEDULE_LIST_EXCEEDED
        );

        bytes32 salt = _useProxies
        ...
        uint256 bulkSize = _scheduleAccessList.length == 0
            ? 7
            : 6 + _scheduleAccessList.length;
