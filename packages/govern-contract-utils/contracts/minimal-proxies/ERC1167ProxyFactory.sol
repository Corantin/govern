...
library ERC1167ProxyFactory {
    ...
    function clone(address _implementation, bytes memory _initData)
        internal
        returns (address cloneAddr)
    {
    ...
    function clone2(address _implementation, bytes32 _salt)
        internal
        returns (address cloneAddr)
    {
        bytes memory createData = generateCreateData(_implementation);
    ...
    ) internal returns (address cloneAddr) {
    ...
    function generateCreateData(address _implementation)
        internal
        pure
